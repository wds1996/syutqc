...
<head>
	...
	<script type="text/javascript">
		...
		function initTable() {
			$.ajax({
				type: 'post',
				url: '<%=basePath%>assess_list.action',
				traditional: true,
		...
		function del(id) {
			if(confirm("确认删除吗?") == true){    
				location.href="<%=basePath%>assess_delete.action?id="+id;
			} 
		}
	</script>
</head>
<body class="childrenBody">
	<blockquote class="layui-elem-quote news_search">
		...
		<form method="post" action="<%=basePath%>assess_keywordSearch.action" class="searchForm">
		...
		<div class="layui-inline">
			<a class="layui-btn layui-btn-normal newsAdd_btn" href="<%=basePath%>page/assess/add.jsp">添加文章</a>
		</div>
	</blockquote>

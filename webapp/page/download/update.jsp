...
<body class="childrenBody">
	...
	<form class="layui-form" action="<%=basePath%>download_update.action" method="post">
		<input name="id" type="text" hidden="hidden" value="${download.id}">
		<div class="layui-form-item">
			<label class="layui-form-label">文件名</label>
			<div class="layui-input-block">
				<input name="name" type="text" value="${download.name}" class="layui-input newsName" lay-verify="required" placeholder="请输入文章标题">
			</div>
		</div>
		<div class="layui-form-item">
			<div class="layui-inline">		
				...
				<div class="layui-input-inline">
					<input name="author" type="text" value="${download.author}" class="layui-input newsAuthor" lay-verify="required" placeholder="请输入文章作者">
				</div>
			</div>
			<div class="layui-inline">		
				<label class="layui-form-label">发布时间</label>
				<div class="layui-input-inline">
					<input type="text" class="layui-input" id="time" name="time" value="${download.time}" autocomplete="off">
				</div>
			</div>
			<div class="layui-inline">

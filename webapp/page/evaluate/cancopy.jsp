...
<!-- 	顶部图片 -->
	...
	<div class="content">
		<div class="content2">
			<div class="content3">
				<div class="content3_title"><strong>${evaluate.way}</strong></div>
			</div>
			<div class="nav_content">
				<div class="ct">
					<div class="ct_title">
						<div class="out_title"><h1>${evaluate.name}</h1></div>
						<div class="out_time">发布时间：${evaluate.time}</div>
						<div class="out_file">下载附件：<a href="<%=basePath%>sanya/file/file/${evaluate.fileName}" download="${evaluate.fileName}">${evaluate.fileName}</a></div>
					</div>
					<div class="ct_content">${evaluate.content}</div>
				</div>
			</div>
		</div>
	</div>

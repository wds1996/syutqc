...
<head>
	...
	<style>
		.content3{background:url(img/zhuanyerenzheng.png) no-repeat;}
	</style>
</head>
<body>
	<div class="top">
...
<!-- 	顶部图片 -->
		...
		<div class="content2">
			<div class="content3">
				...
				<div class="content3_nav">
						<a href="index.jsp">首页</a>><a href="">专业认证</a>
					</div>
			</div>
			<ul class="nav">
			...
			<div class="nav_content">
				<div class="ct">
					<table class="authentication_table" lay-filter="authenticationToPage"></table>
				</div>
			</div>
		</div>
	</div>
	...
	$('.xialaguang').removeClass('navhover');
		...
		table.render({
		  elem: '.authentication_table'
		  ,url: '<%=basePath%>authentication_findAll.action'
		  ,page: mystyle
		  ,skin: 'nob'
		  ,even: true
		  ,size: 'lg'
		  ,cols: [[ 
		    ...
		    ,{field: 'name', title: '专业认证名称', width:'70%'}
		    ,{field: 'time', title: '发布时间', width:'30%', sort: true, align: 'center'}
		  ]]
		});
		table.on('row(authenticationToPage)', function(obj){
			open("<%=basePath%>authentication_findById?id=" + obj.data.id + "");
			});
	});

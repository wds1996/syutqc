...
<!-- 	顶部图片 -->
		...
		<div class="content2">
			<div class="content3">
				...
				<div class="content3_nav">
						<a href="index.jsp">首页</a>><a href="">教学评价</a>
					</div>
			</div>
			<ul class="nav">
			...
			<div class="nav_content">
				<div class="ct">
					<table class="evaluate_table" lay-filter="evaluateToPage"></table>
				</div>
			</div>
		</div>
	</div>
	...
	$('.xialaguang').removeClass('navhover');
		...
		table.render({
		  elem: '.evaluate_table'
		  ,url: '<%=basePath%>evaluate_findAll.action'
		  ,page: mystyle
		  ,skin: 'nob'
		  ,even: true
		  ,size: 'lg'
		  ,cols: [[ 
		    ...
		    ,{field: 'name', title: '教学评价名称', width:'70%'}
		    ,{field: 'time', title: '发布时间', width:'30%', sort: true, align: 'center'}
		  ]]
		});
		table.on('row(evaluateToPage)', function(obj){
			open("<%=basePath%>evaluate_findById?id=" + obj.data.id + "");
			});
	});

...
<!-- 	顶部图片 -->
	...
	<div class="content">
		<div class="content2">
			<div class="content3">
				<!-- <img src="img/bumen2.png" alt=""> -->
					<div class="content3_nav">
						<a href="index.jsp">首页</a>><a href="">政策文件</a>
					</div>
			...
			<div class="nav_content">
				<div class="ct">
					<table class="file_table" lay-filter="fileToPage"></table>
				</div>
			</div>
		</div>
	</div>
	...
	$('.xialaguang').removeClass('navhover');
      ...
      layui.use('table', function(){
		...
		table.render({
		  elem: '.file_table'
		  ,url: '<%=basePath%>file_findAll.action'
		  ,page: mystyle
		  ,skin: 'nob'
		  ,even: true
		  ,size: 'lg'
		  ,cols: [[ 
		    ...
		    ,{field: 'name', title: '政策文件名称', width:'70%'}
		    ,{field: 'time', title: '发布时间', width:'30%', sort: true, align: 'center'}
		  ]]
		});
		table.on('row(fileToPage)', function(obj){
			open("<%=basePath%>file_findById?id=" + obj.data.id + "");
			});
	});

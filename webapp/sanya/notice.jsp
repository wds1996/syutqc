...
<!-- 	顶部图片 -->
	...
	<div class="content">
		<div class="content2">
			<div class="content3">
					<div class="content3_title"><strong>通知公告</strong></div>
					<div class="content3_nav">
						<a href="index.jsp">首页</a>><a href="">通知公告</a>
					</div>
			...
			<div class="nav_content">
				<div class="ct">
					<table class="notice_table" lay-filter="noticeToPage"></table>
				</div>
			</div>
		</div>
	</div>
	...
	$('.xialaguang').removeClass('navhover');
      ...
      layui.use('table', function(){
		...
		table.render({
		  elem: '.notice_table'
		  ,url: '<%=basePath%>notice_findAll.action'
		  ,page: mystyle
		  ,skin: 'nob'
		  ,even: true
		  ,size: 'lg'
		...
		table.on('row(noticeToPage)', function(obj){

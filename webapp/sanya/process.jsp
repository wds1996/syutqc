...
<!-- 	顶部图片 -->
	...
	<div class="content">
		<div class="content2">
			<div class="content3">
				<!-- <img src="img/bumen2.png" alt=""> -->
					<div class="content3_nav">
						<a href="index.jsp">首页</a>><a href="">制度流程</a>
					</div>
			...
			<div class="nav_content">
				<div class="ct">
					<table class="process_table" lay-filter="processToPage"></table>
				</div>
				<div class="ct">
					<table class="schedule_table" lay-filter="scheduleToPage"></table>
				</div>
	...
	$('.xialaguang').removeClass('navhover');
     ...
     layui.use('table', function(){
		...
		table.render({
		  elem: '.process_table'
		  ,url: '<%=basePath%>process_findAll.action'
		  ,page: mystyle
		  ,skin: 'nob'
		  ,even: true
		  ,size: 'lg'
		  ,cols: [[ 
		    ...
		    ,{field: 'name', title: '制度流程名称', width:'70%'}
		    ,{field: 'time', title: '发布时间', width:'30%', sort: true, align: 'center'}
		  ]]
		});
		table.on('row(processToPage)', function(obj){
	...
	layui.use('table', function(){
		...
		table.render({
		  elem: '.schedule_table'
		  ,url: '<%=basePath%>schedule_findAll.action'
		  ,page: mystyle
		  ,skin: 'nob'
		  ,even: true
		  ,size: 'lg'
		  ,cols: [[ 
		    {field: 'id', title: 'ID',hide: true}
		    ,{field: 'name', title: '工作安排名称', width:'70%'}
		    ,{field: 'time', title: '发布时间', width:'30%', sort: true, align: 'center'}
		  ]]
		});
		table.on('row(scheduleToPage)', function(obj){
			  console.log(obj.data.id);
			  open("<%=basePath%>process_findById?id=" + obj.data.id + "");
			});
	}); 
